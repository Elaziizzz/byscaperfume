            ...
            <div className="text-black font-mono print:font-mono w-full max-w-[185mm] mx-auto text-[12px] leading-normal tracking-wide">
              <div className="flex justify-between items-start mb-4">
                <div className="max-w-[80mm] space-y-0.5">
                  <h2 className="text-[14px] font-bold tracking-wider">{activeStore === 'bysca' ? 'BYSCA' : 'BYSCA'}</h2>
                  <p className="text-[11px]">Alamat: {activeStore === 'bysca' ? 'Jl.Raya Barat No.6 Kasturi Cikijing,Majalengka' : '-'}</p>
                  <p className="text-[11px]">Telp  : {activeStore === 'bysca' ? '081323299754 / 085722328871' : '-'}</p>
