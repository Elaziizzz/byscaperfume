            ...
            <div className="text-black font-mono print:font-mono w-full max-w-[185mm] mx-auto text-[10px] leading-tight">
              <div className="flex justify-between items-start mb-3">
                <div className="max-w-[75mm]">
                  <h2 className="text-sm font-bold tracking-wider">{activeStore === 'bysca' ? 'BYSCA' : 'BYSCA'}</h2>
                  <p className="mt-1">Alamat: {activeStore === 'bysca' ? 'Jl.Raya Barat No.6 Kasturi Cikijing,Majalengka' : '-'}</p>
                  <p>Telp: {activeStore === 'bysca' ? '081323299754 / 085722328871' : '-'}</p>
