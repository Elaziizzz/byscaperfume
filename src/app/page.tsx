                    ...
                    <div className="shrink-0 mb-1.5">
                      <div className="flex justify-between items-start mb-1 text-[13px]">
                        <div className="max-w-[92mm] leading-tight space-y-0.5">
                          <h2 className="text-[15.5px] font-bold tracking-wider">{activeStore === 'bysca' ? 'BYSCA' : 'BYSCA'}</h2>
                          <p>Alamat: {activeStore === 'bysca' ? 'Jl.Raya Barat No.6 Kasturi Cikijing,Majalengka' : '-'}</p>
